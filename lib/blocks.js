...
BlockController.prototype.getBlockReward = function(height) {
  var subsidy = new BN(420 * 1e8);

  if(nHeight > 920000) {
     subsidy = new BN(50 * 1e8);
    ...
    var halvings = Math.floor(height, 280000);
    // Force block reward to zero when right shift is undefined.
    if (halvings >= 64) {
        return 0;
    }
  }
  // Subsidy is cut in half every 280,000 blocks which will occur approximately every 4 years.
